...
drop policy if exists "cms_posts_select_own" on public.cms_posts;
...
drop policy if exists "cms_posts_insert_own" on public.cms_posts;
...
drop policy if exists "cms_posts_update_own" on public.cms_posts;
...
drop policy if exists "cms_posts_delete_own" on public.cms_posts;
